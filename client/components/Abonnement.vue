...
<div class ="main_abo">
    <div class="wrapper">
        ...
        <form method="POST">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="email" placeholder="adresse email" required class="name">
            ...
            <div class="input-group">
                <div class="input-box">
                    ...
                    <input type="text" placeholder="MM/DD" class="dob">
            ...
            <div class="input-group">
                <div class="input-box">
                    <h4> Details du paiment </h4>
                    <input type="radio" name="pay" id="bc1" checked class="radio">
                    <label for="bc1"><span><i class="fa fa-cc-visa"></i> Carte de crédit </span></label>
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="tel" placeholder="Numéro de carte" maxlength="12" required class="name">
                    <i class="fa fa-credit-card icon"></i>
                </div>
            </div>
            <div class="input-group">
                <div class="input-box">
                    <input type="tel" placeholder="CVC" maxlength="3" required class="name">
                    <i class="fa fa-user icon"></i>
                </div>
            </div>
            <div class="input-box">
