<template>
    <div class="container">
        <h1 class="titre"> $ spotifric $ ou le monde <strong> riche </strong> en <strong> musique </strong> !</h1>
        <div class="parallax">
...
.parallax {
  background: url("../../ressources/images/spotifricjust.png") no-repeat center;
